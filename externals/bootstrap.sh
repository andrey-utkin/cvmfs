...
if [[ -v BUILTIN_EXTERNALS_LIST ]] && ! echo ";${BUILTIN_EXTERNALS_LIST};" | grep -qE ";(libarchive|vjson);"; then
...
if [[ -v BUILTIN_EXTERNALS_EXCLUDE ]] && ! echo ";${BUILTIN_EXTERNALS_EXCLUDE};" | grep -qE ";(libarchive|json);"; then
    # Convert semicolon-separated list to space-separated
