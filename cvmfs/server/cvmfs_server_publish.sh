cvmfs_server_publish() {
  ...
  for name in $names; do
    ...
    sudo $user_shell "CVMFS_COMPRESSION_ALGORITHM=$CVMFS_COMPRESSION_ALGORITHM CVMFS_DECOMPRESSION_ALGORITHM=$CVMFS_DECOMPRESSION_ALGORITHM rr $sync_command" || { publish_failed $name; die "Synchronization failed\n\nExecuted Command:\n$sync_command";   }
